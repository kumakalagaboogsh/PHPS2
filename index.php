...
if($first_name && $middle_name && $last_name && $gender && $preffix && $seven_digit && $email) {
    ...
    $first_nameErr = "Letra lang at space ang kailangan wag kagn jejemon!";
}else{
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
         ...
         $count_seven_digit_string = strlen($seven_digit);
            ...
            if($count_seven_digit_string < 7){
                $seven_digitErr = "Masyadong maiksi ang seven digit mo kapatid.";

            }else{

                function random_password($length = 5) {
                    $str = "abcdefghiklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890";
...
<option reffix id="preffix" value="0813" <?php if($preffix == "0813") { echo "selected"; } ?>>0813</option>
<option reffix id="preffix" value="0817" <?php if($preffix == "0817") { echo "selected"; } ?>>0817</option>
<option reffix id="preffix" value="0905" <?php if($preffix == "0905") { echo "selected"; } ?>>0905</option>
<option reffix id="preffix" value="0906" <?php if($preffix == "0906") { echo "selected"; } ?>>0906</option>
<option reffix id="preffix" value="0907" <?php if($preffix == "0907") { echo "selected"; } ?>>0907</option>
