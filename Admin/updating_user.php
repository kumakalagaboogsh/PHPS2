...
if($new_first_name && $new_middle_name && $new_last_name && $new_seven_digit && $new_email) {
  mysqli_query($connections, "UPDATE tbl_user SET first_name='$db_first_name', middle_name='$db_middle_name', last_name='$db_last_name', gender='$db_gender', preffix='$db_preffix', seven_digit='$db_seven_digit', email='$db_email' WHERE id_user='$id_user'");
